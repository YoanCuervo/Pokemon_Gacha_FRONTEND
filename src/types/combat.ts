...
// COPIE FRONT du fichier back src/types/combat.ts — LE BACK FAIT FOI.
// Toute évolution du contrat se fait côté back, puis se recopie ici
// à l'identique. Ne jamais modifier ce fichier seul.
